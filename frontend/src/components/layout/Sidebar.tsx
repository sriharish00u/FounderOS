...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-[232px] shrink-0 border-r border-[var(--ink)] bg-[var(--paper)] p-[22px_22px_22px_28px] flex flex-col justify-between min-h-[calc(100vh-44px)] select-none">
      <div className="flex flex-col gap-[22px]">
        <div>
          ...
          <div className="font-mono-custom text-[11px] text-[var(--muted)] tracking-[0.06em] mt-1 truncate">
            {company.name}
          </div>
        </div>
